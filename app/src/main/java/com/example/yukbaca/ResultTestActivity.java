...
public class ResultTestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    int score, scorehuruf, scorebunyi, scorekata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yea = MediaPlayer.create(this, R.raw.tepuk);
        yea.start();
        ...
        scorehuruf = intent.getIntExtra("scorehuruf", 0);
        tvHuruf.setText("" + scorehuruf);

        scorebunyi = intent.getIntExtra("scorebunyi", 0);
        tvHuruf.setText("" + scorebunyi);

        scorekata = intent.getIntExtra("scorekata", 0);
